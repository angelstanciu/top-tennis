    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans flex flex-col">
      ...
      <div className="max-w-3xl mx-auto w-full px-6 py-12 flex-1">
        <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-8 md:p-12 shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800">
          <h2 className="text-3xl font-black text-slate-800 dark:text-slate-100 mb-8" style={{ fontFamily: 'Outfit, sans-serif' }}>Politica de Utilizare Cookies</h2>
          
          <div className="space-y-6 text-slate-600 dark:text-slate-400 leading-relaxed">
            <section>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">1. Ce sunt Cookie-urile?</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">2. Cum folosim Cookie-urile?</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">3. Cookie-uri de Terță Parte (Marketing)</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">4. Controlul cookie-urilor</h3>
