    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans flex flex-col">
      ...
      <div className="max-w-3xl mx-auto w-full px-6 py-12 flex-1">
        <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-8 md:p-12 shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800">
          <h2 className="text-3xl font-black text-slate-800 dark:text-slate-100 mb-8" style={{ fontFamily: 'Outfit, sans-serif' }}>Termeni și Condiții</h2>
          
          <div className="space-y-6 text-slate-600 dark:text-slate-400 leading-relaxed">
            <section>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">1. Introducere</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">2. Rezervări și Anulări</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">3. Politica de Livrare</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">4. Regulamentul Bazei Sportive</h3>
            ...
            <section>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">5. Plăți</h3>
              <p>Plata contravalorii orelor rezervate se face la recepția bazei sportive (cash sau card) înainte de începerea partidei.</p>
            </section>

            <section>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">6. Forță majoră</h3>
            ...
            <p className="text-sm text-slate-400 mt-10 pt-6 border-t border-slate-100 dark:border-slate-800 italic">Ultima actualizare: Martie 2026</p>
          </div>
        </div>
      </div>
