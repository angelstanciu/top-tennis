...
export default function PlayerAuthPage() {
  ...
  return (
    <div
      className="min-h-screen flex font-sans overflow-hidden selection:bg-lime-500 selection:text-black transition-colors"
      style={{ background: isDark ? '#020617' : '#f6f7f4', color: isDark ? '#f8fafc' : '#0f172a' }}
    >

      {/* LEFT SIDE: Visual Branding (Hidden on mobile) */}
      <div className="hidden lg:flex w-1/2 relative overflow-hidden" style={{ background: isDark ? '#0f172a' : '#e2e8f0' }}>
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              background: isDark
                ? 'linear-gradient(to right, #020617, rgba(2,6,23,0.6), transparent)'
                : 'linear-gradient(to right, #f6f7f4, rgba(246,247,244,0.65), transparent)'
            }}
          />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-16 w-full">
          <div onClick={() => nav('/')} className="cursor-pointer">
            <h1 className="text-3xl font-black tracking-tighter" style={{ fontFamily: 'Outfit, sans-serif', color: isDark ? '#fff' : '#0f172a' }}>
          ...
          <div className="space-y-4 max-w-sm">
            ...
            <p className="text-base font-medium leading-relaxed" style={{ color: isDark ? '#94a3b8' : '#64748b' }}>
              Rezervă terenul favorit și dă startul pasiunii tale. Simplu, rapid și direct de pe telefon.
            </p>
          </div>

          <div className="flex items-center gap-6 border-t pt-6" style={{ borderColor: isDark ? 'rgba(255,255,255,0.05)' : '#cbd5e1' }}>
            <div>
              <div className="text-2xl font-black leading-none" style={{ color: isDark ? '#fff' : '#0f172a' }}>1.2k+</div>
              <div className="text-[9px] font-bold uppercase tracking-widest mt-1" style={{ color: isDark ? '#64748b' : '#64748b' }}>Jucători</div>
            </div>
            <div>
              <div className="text-2xl font-black leading-none" style={{ color: isDark ? '#fff' : '#0f172a' }}>15</div>
              <div className="text-[9px] font-bold uppercase tracking-widest mt-1" style={{ color: isDark ? '#64748b' : '#64748b' }}>Terenuri</div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16 relative">
        <div className="absolute top-8 left-8 lg:hidden z-20">
             <h1 onClick={() => nav('/')} className="text-2xl font-black tracking-tighter cursor-pointer" style={{ fontFamily: 'Outfit, sans-serif', color: isDark ? '#fff' : '#0f172a' }}>
               STAR<span className="text-lime-400">ARENA</span>
             </h1>
        </div>
        ...
        <button
           onClick={() => nav('/')}
           className={`absolute top-8 right-8 transition-colors group flex items-center gap-2 ${isDark ? 'text-slate-500 hover:text-white' : 'text-slate-400 hover:text-slate-900'}`}
        >
            ...
            {authMode === 'otp' ? (
              ...
              >
                <div className="space-y-2">
                  ...
                  <h3 className="text-2xl font-black tracking-tight" style={{ color: isDark ? '#f8fafc' : '#0f172a' }}>Logare prin SMS</h3>
                  <p className="text-sm" style={{ color: isDark ? '#94a3b8' : '#64748b' }}>Vei primi un cod de acces pe telefon.</p>
                </div>
                ...
                {otpStep === 1 ? (
                  <form onSubmit={handleRequestOtp} className="space-y-6">
                    <div className="space-y-2">
                       <label className="text-[11px] font-bold uppercase tracking-widest ml-1" style={{ color: isDark ? '#94a3b8' : '#475569' }}>Număr Telefon</label>
                       <div className="relative">
                         <Smartphone className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: isDark ? '#475569' : '#94a3b8' }} />
                         <input
                            type="tel"
                            placeholder="07XX XXX XXX"
                            className="w-full rounded-2xl py-4 pl-14 pr-6 text-lg focus:outline-none focus:ring-2 focus:ring-lime-500/50 transition-all sa-form-input"
                    ...
                    <button
                      ...
                      className="w-full font-black py-4 rounded-2xl transition-all shadow-lg shadow-lime-500/10 disabled:opacity-50"
                      style={{ background: isDark ? '#a3e635' : '#84cc16', color: '#020617' }}
                    >
                  ...
                  <form onSubmit={handleVerifyOtp} className="space-y-6">
                    <div className="space-y-2">
                       <label className="text-[11px] font-bold uppercase tracking-widest ml-1" style={{ color: isDark ? '#94a3b8' : '#475569' }}>
                         Cod Primit
                       </label>
                       <div className="relative">
                         <input
                            type="text"
                            placeholder="000000"
                            className="w-full rounded-2xl py-4 px-6 text-3xl font-mono tracking-[0.5em] text-center focus:outline-none focus:ring-2 focus:ring-lime-500/50 transition-all sa-form-input"
                            style={{ background: isDark ? '#0b1120' : '#f8fafc', border: `1.5px solid ${isDark ? '#1e293b' : '#e2e8f0'}`, color: isDark ? '#e2e8f0' : '#0f172a' }}
                            value={otp}
              ...
              >
                <div className="space-y-2">
                  <h3 className="text-3xl font-black tracking-tighter" style={{ color: isDark ? '#f8fafc' : '#0f172a' }}>
                  ...
                  <>
                    <div className="flex flex-col gap-3 lg:gap-4">
                      <motion.button 
                        ...
                        onClick={() => googleLogin()}
                        disabled={loading}
                        className="flex flex-1 items-center justify-center gap-2 lg:gap-3 rounded-xl lg:rounded-2xl py-3.5 lg:py-4 transition-all font-black text-xs lg:text-sm relative overflow-hidden group shadow-xl"
                        style={{ background: isDark ? 'rgba(255,255,255,0.05)' : '#ffffff', border: `1px solid ${isDark ? 'rgba(255,255,255,0.1)' : '#e2e8f0'}`, color: isDark ? '#f8fafc' : '#0f172a' }}
                      >
                    ...
                    <div className="flex items-center gap-4 py-1">
                      <div className="flex-grow border-t" style={{ borderColor: isDark ? 'rgba(255,255,255,0.05)' : '#e2e8f0' }}></div>
                      <span className="text-[10px] font-black uppercase tracking-widest" style={{ color: isDark ? '#334155' : '#94a3b8' }}>sau cu telefon</span>
                      <div className="flex-grow border-t" style={{ borderColor: isDark ? 'rgba(255,255,255,0.05)' : '#e2e8f0' }}></div>
                    </div>
                  </>
                )}
                    ...
                    <div className="flex items-start gap-4 p-4 lg:p-5">
                      ...
                      <div className="flex-grow space-y-3">
                        <div className="space-y-1">
                          <h4 className="text-sm font-bold tracking-tight" style={{ color: isDark ? '#fff' : '#0f172a' }}>Ups! Problemă de Autentificare</h4>
                        ...
                        {errorDetails.type === 'NOT_FOUND' && (
                          <div className="flex flex-wrap gap-2">
                            ...
                            <button
                              ...
                              style={{ background: isDark ? 'rgba(255,255,255,0.05)' : '#f1f5f9', color: isDark ? '#94a3b8' : '#64748b' }}
                            >
                   ...
                   >
                     {error.includes("No static resource") || error.includes("execute statement") ? (
                       <div className="space-y-2">
                         ...
                         <button
                            onClick={() => setAuthMode('otp')}
                            className="text-[10px] font-bold py-1 px-3 rounded-lg transition-all uppercase tracking-widest"
                            style={{ background: isDark ? 'rgba(255,255,255,0.1)' : '#f1f5f9', color: isDark ? '#fff' : '#0f172a' }}
                         >
                           Folosește SMS/OTP
                         </button>
                       </div>
                ...
                <form onSubmit={authMode === 'login' ? handleLogin : authMode === 'forgot' ? handleForgotPassword : authMode === 'reset' ? handleResetPassword : handleRegister} className="space-y-3 lg:space-y-4">
                   {authMode === 'signup' && (
                      <div className="space-y-1.5">
                        <label className="text-[9px] font-bold uppercase tracking-widest ml-1" style={{ color: isDark ? '#94a3b8' : '#475569' }}>Nume Complet</label>
                        <div className="relative">
                          <User className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5" style={{ color: isDark ? '#475569' : '#94a3b8' }} />
                          <input
                             type="text"
                             placeholder="Alex Ionescu"
                             className="w-full rounded-xl lg:rounded-2xl py-3.5 pl-11 pr-5 text-sm focus:outline-none focus:ring-1 focus:ring-lime-500/50 transition-all sa-form-input"
                             style={{ background: isDark ? '#0b1120' : '#f8fafc', border: `1.5px solid ${isDark ? '#1e293b' : '#e2e8f0'}`, color: isDark ? '#e2e8f0' : '#0f172a' }}
                             value={fullName}
                   ...
                   {authMode === 'signup' && (
                      <div className="space-y-1.5">
                        <label className="text-[9px] font-bold uppercase tracking-widest ml-1" style={{ color: isDark ? '#94a3b8' : '#475569' }}>Email (Opțional)</label>
                        <div className="relative">
                          <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5" style={{ color: isDark ? '#475569' : '#94a3b8' }} />
                          <input
                             type="email"
                   ...
                   {(authMode === 'login' || authMode === 'forgot' || authMode === 'reset') && (
                     <div className="space-y-1.5">
                        <label className="text-[9px] font-bold uppercase tracking-widest ml-1" style={{ color: isDark ? '#94a3b8' : '#475569' }}>Telefon sau Email</label>
                        <div className="relative">
                          <User className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5" style={{ color: isDark ? '#475569' : '#94a3b8' }} />
                          <input
                             type="text"
                             placeholder="07XX XXX XXX sau adresa de email"
                             className="w-full rounded-xl lg:rounded-2xl py-3.5 pl-11 pr-5 text-sm focus:outline-none focus:ring-1 focus:ring-lime-500/50 transition-all disabled:opacity-50 sa-form-input"
                             style={{ background: isDark ? '#0b1120' : '#f8fafc', border: `1.5px solid ${isDark ? '#1e293b' : '#e2e8f0'}`, color: isDark ? '#e2e8f0' : '#0f172a' }}
                             value={identifier}
                   ...
                   {authMode === 'signup' && (
                     <div className="space-y-1.5">
                        <label className="text-[9px] font-bold uppercase tracking-widest ml-1" style={{ color: isDark ? '#94a3b8' : '#475569' }}>Număr Telefon</label>
                        <div className="relative">
                          <Smartphone className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5" style={{ color: isDark ? '#475569' : '#94a3b8' }} />
                          <input
                             type="tel"
                             placeholder="07XX XXX XXX"
                             className="w-full rounded-xl lg:rounded-2xl py-3.5 pl-11 pr-5 text-sm focus:outline-none focus:ring-1 focus:ring-lime-500/50 transition-all font-mono tracking-wider sa-form-input"
                             style={{ background: isDark ? '#0b1120' : '#f8fafc', border: `1.5px solid ${isDark ? '#1e293b' : '#e2e8f0'}`, color: isDark ? '#e2e8f0' : '#0f172a' }}
                             value={phone}
                             onChange={e => setPhone(e.target.value.replace(/\D/g, '').slice(0, 10))}
                             required
                   ...
                   {authMode === 'reset' && (
                      <div className="space-y-1.5">
                        <label className="text-[9px] font-bold uppercase tracking-widest ml-1" style={{ color: isDark ? '#94a3b8' : '#475569' }}>Cod Resetare Primit</label>
                        <div className="relative">
                          <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5" style={{ color: isDark ? '#475569' : '#94a3b8' }} />
                          <input
                             type="text"
                             placeholder="Cod din 6 cifre"
                             className="w-full rounded-xl lg:rounded-2xl py-3.5 pl-11 pr-5 text-sm tracking-widest font-mono focus:outline-none focus:ring-1 focus:ring-lime-500/50 transition-all sa-form-input"
                             style={{ background: isDark ? '#0b1120' : '#f8fafc', border: `1.5px solid ${isDark ? '#1e293b' : '#e2e8f0'}`, color: isDark ? '#e2e8f0' : '#0f172a' }}
                             value={otp}
                             onChange={e => setOtp(e.target.value.replace(/\D/g, '').slice(0, 6))}
                             required
                   ...
                   {authMode === 'signup' && (
                     <div className="flex items-start gap-3 rounded-xl px-4 py-3" style={{ background: isDark ? 'rgba(30,41,59,0.6)' : '#f1f5f9', border: `1px solid ${isDark ? 'rgba(255,255,255,0.05)' : '#e2e8f0'}` }}>
                       ...
                       <span className="text-[11px] leading-relaxed" style={{ color: isDark ? '#94a3b8' : '#64748b' }}>
                         Prin crearea contului, ești informat că{' '}
                         <strong style={{ color: isDark ? '#cbd5e1' : '#334155' }}>prenumele tău va fi vizibil altor utilizatori</strong>
                   ...
                   {authMode !== 'forgot' && (
                     <div className="space-y-1.5">
                        <div className="flex justify-between items-center ml-1">
                          <label className="text-[9px] font-bold uppercase tracking-widest" style={{ color: isDark ? '#94a3b8' : '#475569' }}>{authMode === 'reset' ? 'Noua Parolă' : 'Parolă'}</label>
                          {authMode === 'login' && (
                             <button type="button" onClick={() => setAuthMode('forgot')} className={`text-[9px] font-bold transition-colors uppercase tracking-widest ${isDark ? 'text-lime-500 hover:text-white' : 'text-lime-600 hover:text-slate-900'}`}>Ai uitat-o?</button>
                          )}
                        </div>
                        <div className="relative">
                          <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5" style={{ color: isDark ? '#475569' : '#94a3b8' }} />
                   ...
                   <button
                      ...
                      className="w-full font-black py-4 rounded-xl lg:rounded-2xl transition-all shadow-lg shadow-lime-500/10 disabled:opacity-50 mt-2 flex items-center justify-center gap-2 group"
                      style={{ background: isDark ? '#a3e635' : '#84cc16', color: '#020617' }}
                    >
                ...
                {(authMode === 'forgot' || authMode === 'reset') ? (
                  <div className="pt-2 lg:pt-4 border-t text-center" style={{ borderColor: isDark ? 'rgba(255,255,255,0.05)' : '#e2e8f0' }}>
                    <p className="text-xs lg:text-sm" style={{ color: isDark ? '#64748b' : '#94a3b8' }}>
                      Ți-ai amintit parola?
                      <button
                        onClick={() => setAuthMode('login')}
                        className={`ml-2 font-bold transition-colors underline decoration-lime-500/30 underline-offset-4 ${isDark ? 'text-lime-500 hover:text-white' : 'text-lime-600 hover:text-slate-900'}`}
                      >
                         Autentificare
                      </button>
                    </p>
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.03] z-0" style={{ backgroundImage: `radial-gradient(${isDark ? '#ffffff' : '#0f172a'} 1px, transparent 1px)`, backgroundSize: '40px 40px' }} />
    </div>
  );
}
