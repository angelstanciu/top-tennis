...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("select b from Booking b where b.bookingDate = :date and b.startTime = :start and b.court.id = :courtId and b.customerPhone = :phone and b.customerName = :name")
    ...
    @Query("select b from Booking b where b.bookingDate = :date and b.endTime = :end and b.court.id = :courtId and b.customerPhone = :phone and b.customerName = :name")
